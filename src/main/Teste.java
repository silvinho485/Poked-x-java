        ...
        */
        ...
        while(indice != 0){
            ...
            if(indice == 0)
                ...
                System.out.println("OBS: POR PADRAO TODOS OS NOVOS IRAO COMEÇAR COM STATUS 20\n\n");
                //SERA RECOLHIDO AS INFORMAÇOES ABAIXO
                pokemons.add(new Pokemon(quantia, le.next(), new Tipo(le.next(), le.next()), new Status(20, 2, 20, 20, 20)));
            }else
